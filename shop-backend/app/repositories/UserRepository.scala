...
class UserRepository  @Inject()(dbConfigProvider: DatabaseConfigProvider)(implicit ec: ExecutionContext) {
    ...
    class UserTable(tag: Tag) extends Table[User](tag, "user") {
        ...
        def googleTokenExpiryDate = column[Timestamp]("google_token_expiry_date")
        def githubToken = column[String]("github_token")
        def githubTokenExpiryDate = column[Timestamp]("github_token_expiry_date")
